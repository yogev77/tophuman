    ...
    <div className="bg-slate-800 rounded-xl p-4 sm:p-6">
      ...
      {phase === 'idle' && (
        <div className="text-center pb-6">
          <div className="mb-4 max-w-sm mx-auto"><GameThumbnail gameId="drag_sort" isPlayable={true} /></div>
      ...
      {phase === 'loading' && <GameLoading gameId="drag_sort" message="Preparing items..." />}
      ...
      {phase === 'completed' && result && (
        <div className="text-center py-8">
          ...
          <div className="grid grid-cols-2 gap-3 max-w-xs mx-auto">
            ...
            <ShareScore gameName="Drag Sort" score={result.score || 0} rank={result.rank} inline />
          </div>
        </div>
      )}
