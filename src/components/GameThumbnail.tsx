...
function ReactionTime() {
  return (
    <>
      <rect width="480" height="200" rx="8" className="fill-amber-100 dark:fill-amber-900/20" />
      {/* Circle behind bolt */}
      <circle cx="240" cy="100" r="70" className="fill-amber-300/30 dark:fill-amber-500/15" />
      {/* Lightning bolt — Zap icon style */}
      <path d="M252,30 L222,105 L244,105 L228,170 L268,88 L246,88 Z" className="fill-amber-400" />
      <path d="M252,30 L222,105 L244,105 L228,170 L268,88 L246,88 Z" fill="none" strokeWidth="3" strokeLinejoin="round" className="stroke-amber-500" />
      {/* Green pill left */}
      ...
      {/* Timer arcs */}
      <circle cx="100" cy="150" r="20" fill="none" strokeWidth="4" className="stroke-amber-300/50" />
      <path d="M100 130 A20 20 0 0 1 120 150" fill="none" strokeWidth="4" className="stroke-amber-500" />
      <circle cx="380" cy="150" r="20" fill="none" strokeWidth="4" className="stroke-amber-300/50" />
      <path d="M380 130 A20 20 0 1 0 360 150" fill="none" strokeWidth="4" className="stroke-amber-500" />
    </>
  )
}
...
function EmojiKeypad() {
  const colors = ['fill-rose-400', 'fill-pink-400', 'fill-red-300', 'fill-rose-300',
    'fill-fuchsia-400', 'fill-rose-500', 'fill-pink-300', 'fill-red-400',
    'fill-rose-400/70', 'fill-pink-500', 'fill-fuchsia-300', 'fill-rose-300/80']
  return (
    <>
      <rect width="480" height="200" rx="8" className="fill-rose-100 dark:fill-rose-900/20" />
      {/* 3x4 keypad grid */}
      {[0, 1, 2, 3].map(row =>
        [0, 1, 2].map(col => (
          <rect
...
function AudioPattern() {
  return (
    <>
      <rect width="480" height="200" rx="8" className="fill-indigo-100 dark:fill-indigo-900/20" />
      {/* 2x2 Simon buttons — tight together */}
      ...
      {/* Active glow on green */}
      <rect x="242" y="25" width="68" height="68" rx="16" className="fill-green-200/40" />
      {/* Sound waves */}
      <path d="M100 80 Q90 100 100 120" fill="none" strokeWidth="3" className="stroke-indigo-400/60" />
      <path d="M90 70 Q75 100 90 130" fill="none" strokeWidth="3" className="stroke-indigo-400/40" />
      <path d="M380 80 Q390 100 380 120" fill="none" strokeWidth="3" className="stroke-indigo-400/60" />
      <path d="M390 70 Q405 100 390 130" fill="none" strokeWidth="3" className="stroke-indigo-400/40" />
    </>
  )
}
...
function WhackAMole() {
  return (
    <>
      ...
      {/* Ground */}
      <rect x="0" y="140" width="480" height="60" rx="0" className="fill-green-300/50 dark:fill-green-800/30" />
      {/* 3 holes */}
      {[120, 240, 360].map((cx, i) => (
        <g key={i}>
          <ellipse cx={cx} cy={155} rx="50" ry="16" className="fill-green-800/30 dark:fill-green-950/40" />
...
function TypingSpeed() {
  ...
  return (
    <>
      <rect width="480" height="200" rx="8" className="fill-violet-100 dark:fill-violet-900/20" />
      {/* Keyboard rows */}
      {row1.map((x, i) => (
      ...
      {/* Highlighted key */}
      <rect x="175" y="82" width="32" height="28" rx="4" className="fill-violet-400" />
      {/* Cursor blink line */}
      <rect x="340" y="15" width="2" height="18" rx="1" className="fill-violet-500" />
      {/* Text lines above keyboard */}
      <rect x="80" y="15" width="140" height="6" rx="3" className="fill-violet-300/60" />
...
function MentalMath() {
  return (
    <>
      <rect width="480" height="200" rx="8" className="fill-orange-100 dark:fill-orange-900/20" />
      {/* Number block 1 */}
      <rect x="90" y="60" width="70" height="70" rx="12" className="fill-orange-300 dark:fill-orange-700/60" />
      ...
      {/* Plus sign */}
      <rect x="187" y="90" width="26" height="6" rx="3" className="fill-orange-500" />
      <rect x="197" y="80" width="6" height="26" rx="3" className="fill-orange-500" />
      {/* Number block 2 */}
      <rect x="240" y="60" width="70" height="70" rx="12" className="fill-orange-300 dark:fill-orange-700/60" />
      ...
      {/* Equals sign */}
      <rect x="335" y="85" width="26" height="6" rx="3" className="fill-orange-500" />
      <rect x="335" y="97" width="26" height="6" rx="3" className="fill-orange-500" />
      {/* Answer block (dimmer) */}
      <rect x="385" y="68" width="50" height="50" rx="10" className="fill-orange-200/50 dark:fill-orange-800/30" strokeWidth="2" strokeDasharray="6 4" fill="none" />
      <rect x="385" y="68" width="50" height="50" rx="10" className="fill-orange-200/50 dark:fill-orange-800/30" />
      <rect x="398" y="88" width="24" height="8" rx="2" className="fill-orange-400/40" />
    </>
  )
}

/* ─── Color Match (RGB Venn) ─── */
function ColorMatch() {
  return (
    <>
      <rect width="480" height="200" rx="8" className="fill-pink-100 dark:fill-pink-900/20" />
      {/* Three overlapping circles (RGB venn) */}
...
function VisualDiff() {
  return (
    <>
      <rect width="480" height="200" rx="8" className="fill-teal-100 dark:fill-teal-900/20" />
      {/* Left panel */}
      ...
      {/* Divider */}
      <rect x="234" y="30" width="12" height="140" rx="2" className="fill-teal-300/40 dark:fill-teal-700/30" />
      {/* Left shapes */}
      <circle cx="80" cy="70" r="18" className="fill-teal-400/70" />
      <rect x="130" y="55" width="30" height="30" rx="4" className="fill-cyan-400/70" />
      <polygon points="100,130 85,160 115,160" className="fill-emerald-400/70" />
      <circle cx="170" cy="140" r="14" className="fill-teal-300/60" />
      {/* Right shapes — one different */}
      <circle cx="305" cy="70" r="18" className="fill-teal-400/70" />
      <rect x="355" y="55" width="30" height="30" rx="4" className="fill-cyan-400/70" />
      <polygon points="325,130 310,160 340,160" className="fill-emerald-400/70" />
      {/* Different shape - highlighted */}
      <circle cx="395" cy="140" r="14" className="fill-rose-400/70" />
      <circle cx="395" cy="140" r="20" fill="none" strokeWidth="2" strokeDasharray="4 3" className="stroke-rose-500/60" />
    </>
  )
}
...
function FollowMe() {
  return (
    <>
      <rect width="480" height="200" rx="8" className="fill-cyan-100 dark:fill-cyan-900/20" />
      {/* Curved path */}
      <path
      ...
      {[
        ...
        <circle key={i} cx={cx} cy={cy} r={i === 0 || i === 6 ? 8 : 5}
          className={i === 0 ? 'fill-green-400' : i === 6 ? 'fill-cyan-500' : 'fill-cyan-400/60'}
        />
      ))}
      {/* Pencil cursor near middle */}
      <g transform="translate(240,78) rotate(-45)">
        <rect x="-3" y="-16" width="6" height="20" rx="1" className="fill-cyan-500" />
        <polygon points="-3,4 3,4 0,10" className="fill-cyan-700" />
      </g>
    </>
  )
}
...
function DragSort() {
  ...
  return (
    <>
      <rect width="480" height="200" rx="8" className="fill-lime-100 dark:fill-lime-900/20" />
      {/* Horizontal bars */}
      {widths.map((w, i) => {
        const displaced = i === 2
        ...
        return (
          <g key={i}>
            <rect
              ...
              height="28"
              rx="6"
              className={displaced ? 'fill-lime-400' : 'fill-slate-300 dark:fill-slate-600'}
            />
            {/* Grip dots */}
            {[0, 8, 16].map(dy => (
              <g key={dy}>
                <circle cx={150 - xOff} cy={yPositions[i] + yOff + 8 + dy} r="2" className={displaced ? 'fill-lime-700/50' : 'fill-slate-400/50 dark:fill-slate-500/50'} />
                <circle cx={157 - xOff} cy={yPositions[i] + yOff + 8 + dy} r="2" className={displaced ? 'fill-lime-700/50' : 'fill-slate-400/50 dark:fill-slate-500/50'} />
              </g>
            ))}
          </g>
        )
      })}
      {/* Drop shadow for displaced bar */}
...
function DuckShoot() {
  return (
    <>
      <rect width="480" height="200" rx="8" className="fill-emerald-100 dark:fill-emerald-900/20" />
      ...
      {/* Small green decoy target to the right */}
...
function MemoryCards() {
  return (
    <>
      <rect width="480" height="200" rx="8" className="fill-fuchsia-100 dark:fill-fuchsia-900/20" />
      {/* Card 1 — face down */}
      <rect x="50" y="30" width="80" height="130" rx="10" className="fill-fuchsia-300 dark:fill-fuchsia-700/60" />
      <rect x="59" y="39" width="62" height="112" rx="6" className="fill-fuchsia-400/40 dark:fill-fuchsia-600/30" />
      ...
      {/* Card 2 — face down */}
      <rect x="145" y="30" width="80" height="130" rx="10" className="fill-fuchsia-300 dark:fill-fuchsia-700/60" />
      <rect x="154" y="39" width="62" height="112" rx="6" className="fill-fuchsia-400/40 dark:fill-fuchsia-600/30" />
      ...
      />
      {/* Card 4 — revealed (star, matching card 3) */}
  ...
  return (
    <>
      ...
      {positions.slice(0, -1).map(([x1, y1], i) => {
        ...
        return (
          <line key={i} x1={x1} y1={y1} x2={x2} y2={y2} strokeWidth="3" className="stroke-red-300/50 dark:stroke-red-700/30" />
        )
      })}
      {/* Numbered circles */}
      {positions.map(([cx, cy], i) => (
        <g key={i}>
          <circle cx={cx} cy={cy} r="20" className={i < 4 ? 'fill-red-400' : 'fill-slate-300 dark:fill-slate-600'} />
          {/* Number indicator lines */}
...
function ImageRotate() {
  const tileColors = [
    'fill-sky-300/60', 'fill-sky-400/50', 'fill-cyan-300/60',
    'fill-sky-400/40', 'fill-sky-200/60', 'fill-cyan-400/50',
    'fill-sky-300/50', 'fill-cyan-300/50', 'fill-sky-400/60',
  ]
  // Middle tile (row 1, col 1) is rotated — index 4
  const rotatedIdx = 4
  return (
    <>
      <rect width="480" height="200" rx="8" className="fill-sky-100 dark:fill-sky-900/20" />
      {/* 3x3 tile grid */}
      {[0, 1, 2].map(row =>
        [0, 1, 2].map(col => {
          const idx = row * 3 + col
      ...
      <g transform="translate(385, 100)">
        <path
          d="M0,-30 A30,30 0 1,1 -25,15"
          fill="none"
          strokeWidth="4"
          strokeLinecap="round"
          className="stroke-sky-500"
        />
        <polygon points="-30,10 -20,22 -16,6" className="fill-sky-500" />
      </g>
    </>
  )
}
...
function Gridlock() {
  return (
    <>
      ...
      {/* Colored sliding blocks */}
      {/* Horizontal green block — the piece to free (2 wide) */}
      <rect x="145" y="62" width="95" height="36" rx="6" className="fill-green-400" />
      {/* Vertical blue block (3 tall) */}
